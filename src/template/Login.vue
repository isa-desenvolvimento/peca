      ...
      >
        ...
        >
          ...
          <input
            ...
            required=""
            class="appearance-none border bg-yellow w-60 px-3 py-2 border-white placeholder-white text-center text-white focus:outline-none focus:border-white focus:ring-transparent sm:text-sm"
          ...
          <div v-else class="bg-white w-60 grid grid-cols-8">
            <input
              ...
              :autocomplete="inputType"
              required=""
              class="appearance-none border bg-yellow col-span-6 px-3 py-2 border-white placeholder-white text-white focus:outline-none focus:border-white focus:ring-transparent sm:text-sm"
              @change="$emit('update:modelValue', $event.target.value)"
            />
